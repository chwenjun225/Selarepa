...
def is_high_quality_class_docstring(docstring: str) -> bool:
...
def is_high_quality_function_docstring(docstring: str) -> bool:
...
def is_high_quality_docstring(docstring: str, doc_type: str) -> bool:
...
def get_repo_name_from_path(path: str) -> any:
...
def extract_docstrings_from_file(file_path: str) -> any:
    """
...
def main():
    ...
    parser.add_argument('--input-dir', type=str,  default="data/downloaded_repos", help='Input directory containing downloaded repos')
    parser.add_argument('--output-file', type=str,  default="data/parsed_downloaded_repos/docstrings.jsonl", help='Output JSONL file path')
