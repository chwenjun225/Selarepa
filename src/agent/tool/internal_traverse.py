...
class ASTNodeAnalyzer:
    ...
    def get_component_by_path(
        ...
        Args:
            ...
            dependency_path: Path to the dependency in format: folder1.folder2.file.component_name or: folder1.folder2.file.class_name.method_name
    ...
    def get_parent_components(
        ...
        Args:
            ...
            dependency_graph: Optional dictionary mapping component ids to their dependencies. If not provided, will only check the current file. 
